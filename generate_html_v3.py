...
function renderAdvStats() {{
  ...
  _ADV.forEach(function(r) {{
    var key = r[4]; // idCrm
    if (!byPlayer[key]) byPlayer[key] = {{prenom:r[2], nom:r[3], id:r[4], wins:0, total:0, lastClass:r[7]}};
    byPlayer[key].total++;
    if (r[8]==='Oui') byPlayer[key].wins++;
    byPlayer[key].lastClass = r[7];
  }});
  ...
  if (multi.length > 0) {{
    ...
    html += '<table class="table table-sm table-bordered" style="width:auto;font-size:.85em"><thead><tr style="background:#f8f9fa">';
    html += '<th>Joueur</th><th class="text-center">Matchs</th><th class="text-center">V</th><th class="text-center">D</th><th class="text-center">%</th><th class="text-center">Dernier Class.</th></tr></thead><tbody>';
    multi.forEach(function(p) {{
      ...
      html += '<td class="text-center">' + p.lastClass + '</td></tr>';
    }});
