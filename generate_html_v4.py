...
<head>
  ...
  <style>
    /* ═══════════════════════════════════════════════════════════════════════
       Design system — inspiré Linear / Notion Pro
       ═══════════════════════════════════════════════════════════════════════ */
    :root {{
      --bg:          #fafbfc;
      --surface:     #ffffff;
...
<div class="container-fluid py-3">
  ...
  <div class="hero">
    <div class="hero-inner">
      ...
      <div class="stats-row">
        ...
        {('<div class="stat-card" style="border-left-color:#8e44ad"><span class="stat-label">Prochain classement</span><span class="stat-value" style="color:#8e44ad">' + _next_class_str + '</span><span class="stat-label">' + str(_days_to_class) + ' jours</span></div>') if _days_to_class is not None else ''}
      </div>
    </div>
  </div>
  ...
  <!-- Filter bar v3 -->
  <div id="filter-bar">
    <div style="font-size:.68em;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:12px;display:flex;align-items:center;gap:8px">
      <span style="display:inline-block;width:4px;height:14px;background:linear-gradient(180deg,var(--primary),var(--primary-2));border-radius:2px"></span>
      Filtres
    </div>
